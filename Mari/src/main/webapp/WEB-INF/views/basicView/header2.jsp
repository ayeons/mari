...
<header class="header">
		<div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
			...
			<!-- Logo -->
			<div class="logo"><a href="${pageContext.request.contextPath}/"><img class="logo_1" src="${pageContext.request.contextPath}/resources/images/logo.png" alt=""><img class="logo_2" src="${pageContext.request.contextPath}/resources/images/logo_2.png" alt=""><img class="logo_3" src="${pageContext.request.contextPath}/resources/images/logo_3.png" alt=""></a></div>
